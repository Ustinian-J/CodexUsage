...
> 当前版本为 `0.2.3`。项目使用干净的 GitHub Intel 与 Apple Silicon macOS runner 构建验证；在 Release 发布前，请仅从源码或当前仓库的 CI 产物安装。
...
- 菜单栏小页面用独立两行同时展示 5h 与 7d 下次重置时间；底部“打开主界面”只打开 CodexUsage 主窗口，版本更新继续在设置页管理。
