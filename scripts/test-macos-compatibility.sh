...
check_contains Makefile 'SWIFTC_FEATURE_FLAGS += -D CODEXUSAGE_HAS_LIQUID_GLASS'
check_contains Sources/CodexUsageWidget/main.swift '#if compiler(>=6.2) && CODEXUSAGE_HAS_LIQUID_GLASS'
