...
Only the current files listed in [the security audit](docs/SECURITY_AUDIT.md) were imported.
The upstream Git history, automation metadata, notarization script, and release-remote checks
