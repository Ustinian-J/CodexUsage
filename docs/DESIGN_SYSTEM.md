# CodexUsage Design System

本文档定义 CodexUsage 的长期视觉与交互规范。它不是某个版本或某次改版的复盘，而是后续所有界面迭代都应遵守的设计边界。

## 设计立场

CodexUsage 是一个 macOS 菜单栏和桌面工作型工具。它应该安静、清晰、可信，优先服务高频扫视和快速判断，而不是制造展示感。
