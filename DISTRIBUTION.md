...
```text
dist/CodexUsage-<version>-mac-<arch>.dmg
```
...
the **Security** section, click **Open Anyway** for `CodexUsage.app`, then confirm
...
This writes `dist/CodexUsage-<version>-mac-x86_64.dmg` and its `.sha256` file.
...
codesign --verify --deep --strict "/Volumes/CodexUsage/CodexUsage.app"
```
